  ...
  export const SliderData: SliderType [] = [
    {  id:"1",
      ...
      title: "Building Dreams with Precision, Crafting Constructions that Inspire and Endure",
       description: "Lorem ipsum dolor sit amet consectetur. Viverra magna habitant blandit lectus integer pulvinar dui est. Eget consectetur habitant felis egestas molestie amet cras dignissim.",
  ...
  export const MaterialData: MaterialType [] = [
    {
        ...
        description: "Lorem ipsum dolor sit amet consectetur. Arcu nulla ut justo volutpat nulla at."
    },
    {
        id:"2",
        icon: <HomeIcon />,
    ...
    },
    {
        ...
        icon: <HomeIcon />,
        title: "Consultancy Services",
        description: "Mollit anim id est laborum. Consectetur adipiscing elit, sed do eiusmod tempor."
    }
];